...
#Rema changed int to float in batch rate
        self.parser.add_argument('--batch_rate', type=float, default=1, help='rate of batch size')
...
EPOCH_MAPPING = {
    ...
    8: 7,
    16: 15,
    32: 400000, #changed by rema from 15
    64: 4000, #change by rema from 30
    128: 60,
    256: 100
}
