...
#Rema added int in the following line
        batch_size = int(MINIBATCH_MAPPING[current_resolution] * opt.batch_rate)
...
#            print("train_set debug")

#            vutils.save_image(batch[1],"{}/{}/batch[1]_{}".format(opt.checkpoints_dir, opt.project_name, str(epoch)) + "{}".format(iteration) + ".jpg")
#            vutils.save_image(batch[2],"{}/{}/batch[2]_{}".format(opt.checkpoints_dir, opt.project_name, str(epoch)) + "{}".format(iteration) + ".jpg")
#            vutils.save_image(batch[6],"{}/{}/batch[6]_{}".format(opt.checkpoints_dir, opt.project_name, str(epoch)) + "{}".format(iteration) + ".jpg")
        
#            print("train_set debug end")
		...
		#result_img.save("{}/{}/test_result_epoch_{}_iter_{}".format(opt.checkpoints_dir, opt.project_name, str(epoch),str(p)) + ".jpg")
                os.remove(img_name)
            except:
                break
